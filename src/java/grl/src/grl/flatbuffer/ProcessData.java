...
public final class ProcessData extends Table {
  ...
  public static int createProcessData(FlatBufferBuilder builder,
    ...
    ProcessData.addValue(builder, valueOffset);
    ProcessData.addUnit(builder, unitOffset);
    ProcessData.addMax(builder, maxOffset);
    ProcessData.addMin(builder, minOffset);
    ProcessData.addId(builder, idOffset);
    ProcessData.addDisplayName(builder, displayNameOffset);
    ProcessData.addDefaultValue(builder, defaultValueOffset);
    ProcessData.addDataType(builder, dataTypeOffset);
