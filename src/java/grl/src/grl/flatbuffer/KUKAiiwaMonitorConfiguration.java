...
public final class KUKAiiwaMonitorConfiguration extends Table {
  ...
  public static int createKUKAiiwaMonitorConfiguration(FlatBufferBuilder builder,
      int hardwareVersion,
      int torqueSensorLimits,
      boolean isReadyToMove,
      boolean isMastered) {
    builder.startObject(4);
    KUKAiiwaMonitorConfiguration.addTorqueSensorLimits(builder, torqueSensorLimits);
    KUKAiiwaMonitorConfiguration.addHardwareVersion(builder, hardwareVersion);
  ...
  public static void startKUKAiiwaMonitorConfiguration(FlatBufferBuilder builder) { builder.startObject(4); }
