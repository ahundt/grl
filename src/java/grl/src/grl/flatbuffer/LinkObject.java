...
public final class LinkObject extends Table {
  ...
  public grl.flatbuffer.Pose pose(grl.flatbuffer.Pose obj) { int o = __offset(8); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public grl.flatbuffer.Inertia inertia() { return inertia(new grl.flatbuffer.Inertia()); }
  public grl.flatbuffer.Inertia inertia(grl.flatbuffer.Inertia obj) { int o = __offset(10); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
