...
public final class Frame extends Struct {
  public Frame __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static int createFrame(FlatBufferBuilder builder, double position_x, double position_y, double position_z, double orientation_x, double orientation_y, double orientation_z, double orientation_w) {
    builder.prep(8, 56);
    builder.prep(8, 32);
