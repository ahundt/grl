...
public final class StopArm extends Table {
  ...
  public static StopArm getRootAsStopArm(ByteBuffer _bb, StopArm obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public StopArm __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
