...
public final class VrepControlPoint extends Table {
  ...
  public EulerXYZd rotation(EulerXYZd obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public static void finishSizePrefixedVrepControlPointBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
