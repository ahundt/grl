...
public final class TeachArm extends Table {
  ...
  public static TeachArm getRootAsTeachArm(ByteBuffer _bb, TeachArm obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public TeachArm __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
