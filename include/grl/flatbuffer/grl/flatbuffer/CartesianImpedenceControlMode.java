...
public final class CartesianImpedenceControlMode extends Table {
   ...
   */
  public EulerPose stiffness() { return stiffness(new EulerPose()); }
  public EulerPose stiffness(EulerPose obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
   * actual damping to set
   */
  public EulerPose damping() { return damping(new EulerPose()); }
  public EulerPose damping(EulerPose obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
   * [Nm/rad] must be => 0.0
   */
  public double nullspaceStiffness() { int o = __offset(8); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * must be between 0.3-1.0 suggested is 0.7
   */
  public double nullspaceDamping() { int o = __offset(10); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * maximum deviation from set goal in mm and radians
   */
  public EulerPose maxPathDeviation() { return maxPathDeviation(new EulerPose()); }
  public EulerPose maxPathDeviation(EulerPose obj) { int o = __offset(12); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
   * trans: [mm/s] rot: [rad/s]
   */
  public EulerPose maxCartesianVelocity() { return maxCartesianVelocity(new EulerPose()); }
  public EulerPose maxCartesianVelocity(EulerPose obj) { int o = __offset(14); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
   * xyz: Newtons rpy:Nm (all >=0)
   */
  public EulerPose maxControlForce() { return maxControlForce(new EulerPose()); }
  public EulerPose maxControlForce(EulerPose obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
  ...
  public static void addNullspaceStiffness(FlatBufferBuilder builder, double nullspaceStiffness) { builder.addDouble(2, nullspaceStiffness, 0.0); }
  public static void addNullspaceDamping(FlatBufferBuilder builder, double nullspaceDamping) { builder.addDouble(3, nullspaceDamping, 0.0); }
