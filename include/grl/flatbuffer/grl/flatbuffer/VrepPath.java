...
public final class VrepPath extends Table {
  ...
  public VrepControlPoint controlPoints(VrepControlPoint obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void finishSizePrefixedVrepPathBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
