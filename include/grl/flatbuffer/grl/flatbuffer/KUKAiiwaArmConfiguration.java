...
public final class KUKAiiwaArmConfiguration extends Table {
  ...
  public CartesianImpedenceControlMode setCartImpedance(CartesianImpedenceControlMode obj) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public JointImpedenceControlMode setJointImpedance() { return setJointImpedance(new JointImpedenceControlMode()); }
  public JointImpedenceControlMode setJointImpedance(JointImpedenceControlMode obj) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public SmartServo smartServoConfig() { return smartServoConfig(new SmartServo()); }
  public SmartServo smartServoConfig(SmartServo obj) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public FRI FRIConfig() { return FRIConfig(new FRI()); }
  public FRI FRIConfig(FRI obj) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public LinkObject tools(int j) { return tools(new LinkObject(), j); }
  public LinkObject tools(LinkObject obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public ProcessData processData(ProcessData obj, int j) { int o = __offset(26); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public ByteBuffer currentMotionCenterInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 1); }
