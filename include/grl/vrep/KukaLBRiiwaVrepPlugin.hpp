...
///    while(true) kukaVrepPluginPG->run_one();
/// @endcode
///
...
public:
    ...
    KukaVrepPlugin (Params params = defaultParams()) : params_(params)
    {
    ...
    // CThe work class is used to inform the io_service when work starts and finishes.
